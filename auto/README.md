...
Navigate to the 2-tool-agent directory containing your agent folder.
...
Select the "tool_agent" from the dropdown menu in the top-left corner of the UI
...
ADK Built-in Tools Documentation